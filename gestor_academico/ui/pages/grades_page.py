...
class GradesPage(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.assignments_table.horizontalHeader().setResizeMode(1, QHeaderView.ResizeMode.ResizeToContents)
        self.assignments_table.horizontalHeader().setResizeMode(2, QHeaderView.ResizeMode.ResizeToContents)
